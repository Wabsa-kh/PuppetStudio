...
The implementation milestones are tracked in [FEATURE_ROADMAP.md](FEATURE_ROADMAP.md). The roadmap includes appendage and rope physics, deformable meshes, normal-map lighting, throwables, PSD import, expanded input support and richer protocol compatibility. These are not present in 0.6.0.
